...
do
    ...
    If an error occurs while trying to display an error notification, in_error will be true, causing the function to exit immediately and prevent a crash from an endless error loop.]]--
